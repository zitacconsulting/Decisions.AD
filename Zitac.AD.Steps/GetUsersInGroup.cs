...
namespace Zitac.AD.Steps
{
    ...
    [Writable]
    public class GetUsersInGroup : BaseFlowAwareStep, ISyncStep, IDataConsumer, IDataProducer, IDefaultInputMappingStep //, INotifyPropertyChanged
    {
        ...
        public ResultData Run(StepStartData data)
        {
            ...
            try
            {
                ...
                if (RecursiveSearch)
                {
                    Filter = "(&(objectCategory=person)(objectClass=user)(|(memberOf:1.2.840.113556.1.4.1941:=" + FoundGroup.Attributes["distinguishedname"][0] + ")(primaryGroupId=" + RID + ")))";
                }
                else
                {
                    Filter = "(&(objectCategory=person)(objectClass=user)(|(memberOf=" + FoundGroup.Attributes["distinguishedname"][0] + ")(primaryGroupId=" + RID + ")))";
                }
