...
{
    [AutoRegisterStep("Disable User", "Integration", "Active Directory", "Zitac", "User")]
    [Writable]
    public class DisableUser : BaseFlowAwareStep, ISyncStep, IDataConsumer, IDataProducer, IDefaultInputMappingStep //, INotifyPropertyChanged
    {
