...
{
    [AutoRegisterStep("Get Group Members", "Integration", "Active Directory", "Zitac", "Group")]
    [Writable]
    public class GetGroupMembers : BaseFlowAwareStep, ISyncStep, IDataConsumer, IDataProducer //, INotifyPropertyChanged
    {
        ...
        public ResultData Run(StepStartData data)
        {
            ...
            try
            {
                ...
                directorySearcher.Filter = "(&(objectClass=group)(objectCategory=group)(memberOf=" + one.Properties["distinguishedname"] + "))";
                ...
                //dictionary.Add("Users", (object) GroupList.ToArray());
                //dictionary.Add("Computers", (object) GroupList.ToArray());
